...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">اضافة مسئول</h1>
        ...
        <div class="card shadow mb-4 text-right">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">اضافة مسئول جديد</h6>
            </div>
            <form method="POST" action="{{route('teamLeaders.store')}}">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 mb-3 mt-3 mb-sm-0">
                            ...
                            <input
                                style="height: 45px;"
                                type="text"
                                class="form-control form-control-user customer_qty @error('tl_name') is-invalid @enderror"
                                id="tl_name"
                                name="tl_name"
                                value="{{ old('tl_name') }}">
                        ...
                        {{-- <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input
                                style="height: 45px;"
                                type="text"
                                class="form-control form-control-user customer_qty @error('tl_team_name') is-invalid @enderror"
                                id="tl_team_name"
                                name="tl_team_name"
                                value="{{ old('tl_team_name') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input
                                style="height: 45px;"
                                type="text"
                                class="form-control form-control-user customer_qty @error('tl_phone_NO1') is-invalid @enderror"
                                id="tl_phone_NO1"
                                name="tl_phone_NO1"
                                value="{{ old('tl_phone_NO1') }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input
                                style="height: 45px;"
                                type="text"
                                class="form-control form-control-user customer_qty @error('tl_phone_NO2') is-invalid @enderror"
                                id="tl_phone_NO2"
                                name="tl_phone_NO2"
                                value="{{ old('tl_phone_NO2') }}">
